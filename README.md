...
Кампании организатора: отдельное пространство для участников, подключённых
арсеналов и общей хроники. [Сценарии, права, проверки и выпуск](ORGANIZER-CAMPAIGNS.md).
